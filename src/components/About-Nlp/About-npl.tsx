...
const AboutNlp = () => {
    ...
    <>
     ...
     <p className="paragraph"> “A Life Transformation Tool like no other” </p>
     <p className="paragraph"> NLP – Neuro-Linguistic Programming, is a study of human psyche and how our mind responds to various life situations. 
     ...
     <p className="paragraph">      
      ...
      <p className="paragraph">Highest quality, international programs, fully approved by the International Coach Federation.</p>
       ...
       <div>
        ...
        <div className='text-container'>
         ...
         <div id="example-collapse-text" className="collapse-text">
          Whatever you may BE whatever you may DO, this program is  beneficial to YOU! 
          Transforming the lives of Business Professionals to  Home-makers.
        </div>
      </Collapse>
            </div>
          ...
          <Collapse in={open1}>
         <div id="example-collapse-text" className="collapse-text">
         Leaders who make a real difference in the lives of their people and their
          organisation are the people who leave their mark in the business world. 
          What do they have in common? Why do other people look up to them, follow them?
        </div>
      </Collapse>
            </div>
          ...
          <Collapse in={open2}>
         <div id="example-collapse-text" className="collapse-text" >
         Leadership is about having a clear vision, and planning how to effectively achieve that vision.
        </div>
      </Collapse>
            </div>
        ...
        Achieve mastery of NLP by going deeper than ever before.
          ...
          <Collapse in={open4}>
         <div id="example-collapse-text"  className="collapse-text">
         NLP Presuppositions (Beliefs of Excellence) I Model (New Behavior Generator) IOutcome Frames
          I Well-formed Outcomes ISwish Pattern I Reframing IStates IMeta Model I Milton Model
         (Hypnosis& Hypnotic Inductions) INLP Success formula I TFAR Coaching model ISensory Acuity and
          Calibration I Anchoring, Stacking Anchors I Sub-modalities for Coaching I The Communication Model
           I Coachingwith values
        </div>
      </Collapse>
            </div>
