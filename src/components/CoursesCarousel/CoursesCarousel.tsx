...
const CoursesCarousel = () => {
  ...
  <div className='course-section'>
   ...
   <div className='ms'>
       ...
       <div className='item' >
          <img src={"menon.png"} style={{height:"400px", width:"340px"}} /> 
          <h2 > 
            <a> ValsaKumar P Menon </a> 
            </h2>
          <p className='team-position'>Managing Partner & Co-founder – UV Consultants</p>
        </div>
        <div className='item' >
          <img src={"uma.png"} style={{height:"400px", width:"340px"}} /> 
          <h2 > 
     ...
     <div className='item' >
         <img src={"vikram.jpg"} style={{height:"400px", width:"340px"}} /> 
         <h2> 
          <a>Vikram Dhar </a>
          </h2>
          <p className='team-position'>Managing Partner & Co-founder – UV Consultants</p>
     ...
     <div className='item' >
         <img src={"Michael.png"} style={{height:"400px", width:"340px"}} /> 
          <h2> 
            <a>Michael Beale</a>
            </h2>
            <p className='team-position'>Managing Partner & Co-founder – UV Consultants</p>
